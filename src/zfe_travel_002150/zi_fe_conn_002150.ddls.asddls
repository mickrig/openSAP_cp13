...
define view entity zi_fe_conn_002150
  as select from zfe_aconn_002150 as Connection
  association [1..1] to zi_fe_carr_002150 as _Airline on $projection.AirlineID = _Airline.AirlineID
{
