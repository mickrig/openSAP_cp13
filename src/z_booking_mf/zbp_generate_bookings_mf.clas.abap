CLASS zbp_generate_bookings_mf DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zbp_generate_bookings_mf IMPLEMENTATION.

  METHOD if_oo_adt_classrun~main.
    DATA:it_bookings TYPE TABLE OF ztbooking_mf.
    ...
    DELETE FROM ztbooking_mf.
    "   insert the new table entries
    INSERT ztbooking_mf FROM TABLE @it_bookings.

    "   check the result
    SELECT * FROM ztbooking_mf INTO TABLE @it_bookings.
    out->write( sy-dbcnt ).
